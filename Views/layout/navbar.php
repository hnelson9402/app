...
<!-- Navbar Brand-->
<a class="navbar-brand ps-3" href="<?php echo Server::SERVER;?>">Labor</a>
<!-- Sidebar Toggle-->
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="<?php echo Server::SERVER ?>Core/closeSession.php">Cerrar Sesión</a></li>
            </ul>
        </li>
    </ul>
</form>
